...
def ButtonClick(btn): #btn stands for button
    ...
    for i in range(len(Content)+1):
        if i == 55:
            tkinter.messagebox.showerror('Error','You input too many numbers and operators')
...
btnPi = tkinter.Button(Calculator,text='π',command=lambda:ButtonClick('math.pi'),bg=rca)
