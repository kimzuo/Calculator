...
def randomcolor_on():
    global rca,rcb,rcc,rcd,rce,rcf,rcg,rch,rci,rcj,rck
    rca=randomcolor_a()
    rcb=randomcolor_b()
    rcc=randomcolor_c()
    rcd=randomcolor_d()
    ...
    rcj=randomcolor_j()
    rck=randomcolor_k()
    return rca,rcb,rcc,rcd,rce,rcf,rcg,rch,rci,rcj,rck
...
def standardcolor_on():
    global rca,rcb,rcc,rcd,rce,rcf,rcg,rch,rci,rcj,rck
    rca=rcb=rcc=rcd=rce=rcf=rcg=rch=rci=rcj=rck='#e6e6e6'
...
color_list_binds= [btnPlus,btnMinus,btnTime]
